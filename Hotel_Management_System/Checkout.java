...
public class Checkout extends JFrame implements ActionListener {
    ...
    Checkout(){
        ...
        getDetails.setBounds(30, 300, 120,30);
        getDetails.addActionListener(this);
        add(getDetails);

        checkoutbtn = new JButton("Checkout");
        checkoutbtn.setBounds(170, 300, 100,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == getDetails){
            ...
            try{
                ...
                String query2 = "update rooms set availablity = 'Available', cleaning = 'Dirty' where roomNo = '"+roomNo+"' ";
